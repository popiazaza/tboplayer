    ...
    def play(self):
        if  self.play_state==self._OMX_CLOSED:
            if self.playlist.track_is_selected():
                ...
                self.quit_sent_signal = False          # signal  that q has been sent
                self.root.title(self.playlist.selected_track_title[:100] + (self.playlist.selected_track_title[100:] and '..') + " - TBOPlayer")
...
# define buttons 
        ...
        add_button = Button(self.root, width = 15, height = 3, text='Add Track',
        ...
        edit_button = Button(self.root, width = 15, height = 3, text='Edit Track',
        ...
        save_button = Button(self.root, width = 15, height = 3, text = 'Save Playlist',
                           fg='black', command = self.save_list, bg='light grey')
        save_button.grid(row=0, column=5)
        
        clear_button = Button(self.root, width = 15, height = 3, text = 'Clear Playlist',
